...
import com.kenshine.chatnew.message.GroupCreateRequestMessage;
import com.kenshine.chatnew.message.GroupCreateResponseMessage;
import com.kenshine.chatnew.server.session.Group;
...
/**
 * @author ：kenshine
 * @date ：Created in 2022/1/27 14:14
 * @description：
 * @modified By：
 * @version: $
 * 创建群请求处理器
