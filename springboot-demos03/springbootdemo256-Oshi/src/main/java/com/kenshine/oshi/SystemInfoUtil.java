...
import com.kenshine.oshi.model.DisksInfo;
import com.kenshine.oshi.model.NetworkInfo;
import com.kenshine.oshi.model.OSInfo;
import com.kenshine.oshi.model.OSRuntimeInfo;
 ...
 * @Classname OshiUtils
 * @Description 获取硬件信息
 * @Date 2023-10-14 17:11
 * @modified By：
 * @version: 1.0$
 */
public class SystemInfoUtil {
    private static Logger log = LoggerFactory.getLogger(SystemInfoUtil.class);
    ...
    public static double getCpuRate() throws InterruptedException {
        CentralProcessor processor = cn.hutool.system.oshi.OshiUtil.getHardware().getProcessor();
