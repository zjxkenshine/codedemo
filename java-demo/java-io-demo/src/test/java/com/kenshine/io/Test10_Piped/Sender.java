...
public class Sender extends Thread{
    ...
    public void run(){
        //writeShortMessage();
        //程序运行出错！抛出异常 java.io.IOException: Pipe closed
        //PipedReader的缓冲区的默认大小是1024！但是，此时要写入的数据却有1046！所以，一次性最多只能写入1024个字符
        //除非消费者使用 readMessageContinued 接收数据
        writeLongMessage();
    }
