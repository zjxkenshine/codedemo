...
/**
 * @author ：kenshine
 * @date ：Created in 2022/2/21 20:35
 * @description：最低公共节点 方式二
 * @modified By：
 * @version: 1.0$
 *
 * 情况：
 * 1. o1和o2互为最低公共祖先
 * 2. o1和o2不互为最低公共祖先，需要往上找
 *
 * 子树上没有o1也没有o2，返回null
 */
public class Test08_LowestCommonAncestor {
    ...
    public static Node lowestAncestor(Node head, Node o1, Node o2) {
        // 头节点为o1或者o2直接返回 base case
        if (head == null || head == o1 || head == o2) {
            return head;
        }
        // 往上不断返回 o1 或 o2，左子树上没有o1o2则返回null
        Node left = lowestAncestor(head.left, o1, o2);
        // 往上不断返回 o1 或 o2，右子树上没有o1o2则返回null
        Node right = lowestAncestor(head.right, o1, o2);
        // 左树右树都不为空，返回head 情况1不会出现这种情况
