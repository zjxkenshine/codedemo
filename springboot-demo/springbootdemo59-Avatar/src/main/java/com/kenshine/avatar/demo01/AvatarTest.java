package com.kenshine.avatar.demo01;
...
/**
 * @author ：kenshine
 * @date ：Created in 2021/11/5 13:58
 * @description：生成头像测试
 * @modified By：
 * @version: $
 */
public class AvatarTest {
    ...
    public static void generateImg(String name, String outputName) throws IOException {
        ...
        //输出路径
        String filename = "D:\\IdeaWorkSpace\\codedemo\\springboot-demo\\springbootdemo59-Avatar\\src\\main\\resources\\avatar\\"+outputName+".jpg";
