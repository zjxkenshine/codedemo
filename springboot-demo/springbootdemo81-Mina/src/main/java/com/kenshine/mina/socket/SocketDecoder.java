...
public class SocketDecoder implements ProtocolDecoder {
    ...
    private static final AttributeKey CONTEXT = new AttributeKey(SocketDecoder.class, "context");
     ...
     */
    public SocketDecoder(String delimiter) {
     ...
     * @param delimiter The line delimiter to use
     */
    public SocketDecoder(LineDelimiter delimiter) {
     ...
     * @param delimiter The line delimiter to use
     */
    public SocketDecoder(Charset charset, String delimiter) {
     ...
     * @param delimiter The line delimiter to use
     */
    public SocketDecoder(Charset charset, LineDelimiter delimiter) {
        if (charset == null) {
    ...
    /**
     * @return the allowed maximum size of the line to be decoded. If the size of
     *         the line to be decoded exceeds this value, the decoder will throw a
     *         {@link }. The default value is <tt>1024</tt>
     *         (1KB).
     */
     ...
     * {@link }. The default value is <tt>1024</tt> (1KB).
     *
     * @param maxLineLength
    ...
    /**
     * Sets the default buffer size. This buffer is used in the Context to store the
     * decoded line.
     *
     * @param bufferLength
    ...
    /**
     * @return the allowed buffer size used to store the decoded line in the Context
     *         instance.
     */
     ...
     * {@code ProtocolDecoderOutput#write(Object)}. You may override this method to
